...
- **Stammdatenpflege gedämpft (`templates/overview.html`).** „Deals pflegen" ist häufig die größte Zahl der Seite, aber nie dringend - es bekommt eine eigene ruhige Zeile mit dem Zusatz „wenn du Zeit hast", unterhalb der Geld-Kachel.
