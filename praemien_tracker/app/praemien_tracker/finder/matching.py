...
VERWERFEN_GRUND_PRAEMIE_NIEDRIG = "praemie_niedrig"
VERWERFEN_GRUND_NICHT_ANWENDBAR = "nicht_anwendbar"
VERWERFEN_GRUENDE_LABELS = {
    ...
    VERWERFEN_GRUND_PRAEMIE_NIEDRIG: "Prämie zu niedrig",
    VERWERFEN_GRUND_NICHT_ANWENDBAR: "Nicht anwendbar",
}
